...
describe('sentiment analysis', function () {
  ...
  it('should have a minimum sentiment of -.1', function() {
    assert.isAtMost(sentiment, -.2, 'tweet 1');
  });
});
...
describe('sentiment analysis', function () {
  ...
  it('should have a minimum sentiment of -.1', function() {
    assert.isAtMost(sentiment, -.2, 'tweet 2');
  });
});
...
describe('sentiment analysis', function () {
  ...
  it('should have a minimum sentiment of -.1', function() {
    assert.isAtMost(sentiment, -.2, 'tweet 3');
  });
});
...
describe('sentiment analysis', function () {
  ...
  it('should have a minimum sentiment of -.1', function() {
    assert.isAtMost(sentiment, -.2, 'tweet 4');
  });
});
